    ...
    if (mysqli_num_rows($sql2) > 0) {
        ...
        <div class="row10">
                    ...
                    <div class="row14">
                        ...
                        <div class="personal">
                            <label for="lastname">Fullname <input type="text" name="upnokname" value=" ' . $sql1_array['nokname'] . ' "></></label>

                            <label for="lastname">Relationship <input type="text" name="upnokrel" value=" ' . $sql1_array['nokrel'] . ' "></></label>
                            <label for="lastname">Phone Number <input type="text" name="upnokphone" value=" ' . $sql1_array['phone'] . ' "></></label>
                            <label for="lastname">House Address <input type="text" name="upnokaddress" value=" ' . $sql1_array['address'] . ' "></></label>
                        </div>
                    </div>
                    
                    <input type="submit" value="Update Profile" class="submit1" id="nur_updateBtn">
                    </form> 
                    ';
    } else {
        // insert output
